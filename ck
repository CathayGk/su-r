...
哔哩哔哩ck = http-request ^https:\/\/(www|live)\.bilibili\.com\/?.? script-path=https://raw.githubusercontent.com/chavyleung/scripts/master/bilibili/bilibili.cookie.js
[MITM]
hostname = wq.jd.com,m.jingxi.com, *.bilibili.com
